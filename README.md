...
- [4. 快速上手](#4-快速上手)
  ...
  - [4.4. TinyRPC 脚手架(tinyrpc\_generator)](#44-tinyrpc-脚手架tinyrpc_generator)
    ...
    - [4.4.5 tinyrpc\_generator 选项详解](#445-tinyrpc_generator-选项详解)
- [5. 概要设计](#5-概要设计)
...
```
不出意外的话，你的 TinyRPC 服务已经成功的运行起来了。接下来简单测试一下，进入 `order_server/test_client/test_tool` 目录，执行客户端测试工具，如：
```
